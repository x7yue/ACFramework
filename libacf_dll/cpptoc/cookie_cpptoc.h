...
//
// $hash=4e61737326eb61dbd989ea0be8edbd0c77656fa6$
//

#ifndef ACF_CPPTOC_COOKIE_CPPTOC_H_
#define ACF_CPPTOC_COOKIE_CPPTOC_H_
#pragma once
...
class AcfCookieCppToC
    : public AcfCppToCRefCounted<AcfCookieCppToC, AcfCookie, acf_cookie_t> {
 public:
  AcfCookieCppToC();
  virtual ~AcfCookieCppToC();
};

#endif  // ACF_CPPTOC_COOKIE_CPPTOC_H_
